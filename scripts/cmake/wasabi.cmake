...
elseif (DEFINED ENV{WASABI_PLATFORM_TARGET})
    ...
    set (WASABI_PLATFORM_TARGET "$ENV{WASABI_PLATFORM_TARGET}" CACHE PATH "project root" FORCE)
else()
...
elseif (DEFINED ENV{SYSROOT_LINUX_DIR})
    ...
    set (SYSROOT_LINUX_DIR "$ENV{SYSROOT_LINUX_DIR}" CACHE PATH "project root" FORCE)
else()
