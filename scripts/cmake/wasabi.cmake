message ("--------------------------------------------------------------")
message ("-- wasabi.cmake toolchain")
if(DEFINED WASMTIME)
	message("- WASMTIME='${WASMTIME}'")
elseif (DEFINED ENV{WASMTIME})
	message("- WASMTIME=ENV'$ENV{WASMTIME}' instead WASMTIME='${WASMTIME}'")
...
elseif (DEFINED ENV{SYSROOT_DIR})
	message("- SYSROOT_DIR=ENV'$ENV{SYSROOT_DIR}' instead SYSROOT_DIR='${SYSROOT_DIR}'")
...
elseif (DEFINED ENV{LLVM_DIR})
	message("- LLVM_DIR=ENV'$ENV{LLVM_DIR}' instead LLVM_DIR='${LLVM_DIR}'")
...
message("- CLANG_TARGET_TRIPLE='${CLANG_TARGET_TRIPLE}'")
