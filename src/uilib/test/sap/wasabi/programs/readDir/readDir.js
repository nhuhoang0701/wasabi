...
var wasmBinaryFile = 'readDir.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function runAndAbortIfError(func) {
      try {
        ...
        var ASYNCIFY_IMPORTS = ["env.get_character","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await"].map(function(x) {
          return x.split('.')[1];
        });
...
var asmLibraryArg = { "__cxa_atexit": ___cxa_atexit, "__indirect_function_table": wasmTable, "__map_file": ___map_file, "__sys_getdents64": ___sys_getdents64, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "abort": _abort, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "ff_exit": ff_exit, "get_character": get_character, "memory": wasmMemory, "setTempRet0": _setTempRet0, "strftime_l": _strftime_l };
