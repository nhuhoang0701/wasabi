	...
	var WASI_API = {
		...
		getModuleMemoryDataView: function getModuleMemoryDataView() {
			return new DataView(moduleInstanceExports.memory.buffer);
		},
		setModuleInstance: function setModuleInstance(instance) {
		...
		fd_write: function(fd, iovs, iovs_len, nwritten) {
			...
			var view = WASI_API.getModuleMemoryDataView();
